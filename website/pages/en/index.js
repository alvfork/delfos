...
class HomeSplash extends React.Component {
  render() {
    ...
    return (
      <SplashContainer>
        <Logo img_src={`${baseUrl}img/undraw_monitor.png`} />
        <div className="inner">
    ...
    const Description = () => (
      <Block background="light">
        {[
          {
            content:
              'We invite you to collaborate in any way with this project, if you want to contribute with any suggestion or opinion, go ahead. We thank you in advance. This is just the beginning, let\'s grow together',
    ...
    const Showcase = () => {
      ...
      return (
        <div className="productShowcaseSection paddingBottom">
          <h2>Who is Using Delfos?</h2>
          <p>Delfos is building validations for these projects...</p>
